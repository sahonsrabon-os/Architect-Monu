...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
  ...
  context.subscriptions.push(
    vscode.lm.registerLanguageModelChatProvider('zombiecoder-mission-barisal', provider),
  ...
  // isn't dead.
  statusBar.command = 'zombiecoder.mission-barisal.refreshModels';
  statusBar.show();
  ...
  const statusManager = new StatusBarManager(
    ...
    () =>
      vscode.workspace
        ...
        .get<string>('serverUrl', 'http://localhost:9999'),
