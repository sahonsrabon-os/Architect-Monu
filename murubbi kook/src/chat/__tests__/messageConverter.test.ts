...
describe('convertMessage', () => {
  test('converts a plain user text message to a string-content message', () => {
  ...
  test('converts an assistant text message to a string-content message', () => {
  ...
  test('skips image parts and logs when enableImageInput is false', () => {
    ...
    // Image dropped → pure text → string content.
