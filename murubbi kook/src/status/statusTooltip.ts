...
export const TOOLTIP_COMMANDS = {
  Refresh: 'zombiecoder.mission-barisal.refreshModels',
  Configure: 'zombiecoder.mission-barisal.manage',
  Output: 'zombiecoder.mission-barisal.showOutput',
  TestConnection: 'zombiecoder.mission-barisal.testConnection',
  EditHeaders: 'zombiecoder.mission-barisal.editCustomHeaders',
  OpenSettings: 'workbench.action.openSettings',
} as const;

const SETTINGS_QUERY = 'zombiecoder.mission-barisal';
